          ...
          <div className="lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left">
            <div className="max-w-lg">
              ...
              <p className="mt-4 text-lg text-gray-600">
                Create your model for any look. Stop guessing how an outfit would look on you. Upload a photo and let our AI create your personal model, ready to try on anything.
              </p>
